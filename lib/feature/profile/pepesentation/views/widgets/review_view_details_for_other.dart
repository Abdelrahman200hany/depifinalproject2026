...
class ReviewViewDetailsforOthers extends StatelessWidget {
  const ReviewViewDetailsforOthers({super.key, required this.userID});
  final String userID;
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          getIt.get<GetRatesCubit>()..getRates(targetUserId: userID),
        ...
        builder: (context, state) {
          if (state is GetRatesSuccess) {
            ...
            return Column(
              children: [
                ProfileStats(
                  numberOfreviews: value.ratesCount,
