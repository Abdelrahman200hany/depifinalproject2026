...
class UpdataStatusToOnWaytoClinet extends StatelessWidget {
  const UpdataStatusToOnWaytoClinet({super.key, required this.order});
      ...
      child: BlocConsumer<UpdateSimpleOrderCubit, UpdateSimpleOrderState>(
        listener: (context, state) {
          if (state is UpdateSimpleOrderSuccess) {
            ...
            showSuccessSnackBar(context, message: 'تم تحديث حاله الطلب بنجاح');
          }
